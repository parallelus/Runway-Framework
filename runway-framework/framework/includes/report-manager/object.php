...
class Reports_Object extends Runway_Object {
	...
	function site_admin_notice() {		
		...
		if($theme_name != 'runway-framework'){
			...
			echo "<div class='update-nag'>" . sprintf( __( 'A Runway child theme has not been activated. You can create or activate one from the <a href="'.$Themes_Manager_Admin->self_url().'">Runway Themes Manager</a>' ) ) . "</div>";
		}
	}	
