...
<?php if ( $pages ) { ?>
	...
	foreach ( $pages as $page ) {
		...
		<tr class="<?php echo $trClass; ?>">
			<td class="plugin-title">
				<strong><a
						href="admin.php?page=options-builder&navigation=edit-page&page_id=<?php echo $page->settings->page_id ?>"><?php echo $page->settings->title ?></a></strong>

				<div class="row-actions">
					<span class="edit"><a
							href="admin.php?page=options-builder&navigation=edit-page&page_id=<?php echo $page->settings->page_id ?>"
							title="<?php _e( 'Edit this item', 'framework' ); ?>"><?php _e( 'Edit', 'framework' ); ?></a> | </span>
					<span class="view"><a href="admin.php?page=<?php echo $alias; ?>"
					...
					<span class="edit"><a class="submitdelete" title="<?php _e( 'Duplicate this item', 'framework' ); ?>"
										   href="admin.php?page=options-builder&navigation=duplicate-page&page_id=<?php echo $page->settings->page_id ?>"><?php _e( 'Duplicate', 'framework' ); ?></a> | </span>
					<span class="edit"><a
	...
	<?php } else { ?>
		...
		<p>
			<a class="button" href="admin.php?page=options-builder&navigation=new-page"><?php _e( 'Create new admin page', 'framework' ); ?></a>
		</p>
		</div>
	<?php } ?>
