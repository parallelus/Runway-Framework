...
?>
<ul class="subsubsub">
	<li class="all"><a href="admin.php?page=extensions&navigation=all" <?php echo $ext_all_status; ?>><?php echo __( 'All', 'framework' );?> <span class="count">(<?php echo $ext_all_total; ?>)</span></a> |</li>
	<li class="inactive"><a href="admin.php?page=extensions&navigation=inactive" <?php echo $ext_inactive_status; ?>><?php echo __( 'Inactive', 'framework' );?> <span class="count">(<?php echo $ext_inactive_total; ?>)</span></a></li>	
</ul>
...
?>
		<tr <?php if ( $ext_cnt ): ?> class="inactive" <?php else:  ?> calss="active" <?php endif; ?> >
			...
			<td class="plugin-title">
				...
				<?php if ( $ext_cnt ): ?>
					<br><a href="admin.php?page=extensions&navigation=extension-activate&ext=<?php echo urlencode( $ext ); ?>"><?php echo __( 'Activate', 'framework' );?></a> |
					<a style="color: #BC0B0B;" href="admin.php?page=extensions&navigation=del-extension-confirm&ext=<?php echo urlencode( $ext ); ?>"><?php echo __( 'Delete', 'framework' );?></a>
				<?php elseif ( !$ext_cnt ): ?>
					<br><a class="edit" href="admin.php?page=extensions&navigation=extension-deactivate&ext=<?php echo urlencode( $ext ); ?>"><?php echo __( 'Deactivate', 'framework' );?></a>
				<?php endif;?>
			</td>
