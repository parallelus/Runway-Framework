	...
	<div class="changelog">
		...
		<div class="feature-section col two-col">
			<div class="col-1">
				...
				<p><?php _e('Setup theme options and admin pages using the', 'framework'); ?> <a href="<?php echo network_admin_url('admin.php?page=options-builder'); ?>"><?php _e('Options Builder', 'framework'); ?></a>.</p>
