	...
	<div>
		...
		<div class="feature-section images-stagger-right">
			...
			<p><?php echo __('Setup theme options and admin pages using the', 'framework'); ?> <a href="admin.php?page=options-builder"><?php echo __('Options Builder', 'framework'); ?></a>.</p>
	...
	<div>
		...
		<div class="feature-section images-stagger-right">
			...
			<p><?php echo __('Add theme options and custom inputs to admin pages using the', 'framework'); ?> <a href="admin.php?page=options-builder"><?php echo __('Options Builder', 'framework'); ?></a>. <?php echo __('Input types include', 'framework'); ?>:</p>
