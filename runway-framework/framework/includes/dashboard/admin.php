<div id="wpbody">
	<div id="wpbody-content">
		...
		<div class="about-wrap">
			...
			<div class="about-text"><?php echo __('A better way to create WordPress themes. Runway is a powerful development environment for making awesome themes', 'runway'); ?>.</div>
			...
			<h2 class="nav-tab-wrapper tab-controlls">
				<a data-tabrel="#getting-started" href="#getting-started" class="nav-tab nav-tab-active"><?php echo __('Getting Started', 'runway'); ?></a><a data-tabrel="#support" href="#support" class="nav-tab"><?php echo __('Help', 'runway'); ?> &amp; <?php echo __('Support', 'runway'); ?></a><a data-tabrel="#release-notes" href="#release-notes" class="nav-tab"><?php echo __('Release Notes', 'runway'); ?></a><a data-tabrel="#credits" href="#credits" class="nav-tab"><?php echo __('Credits', 'runway'); ?></a>
			</h2>
