...
<a href="<?php echo admin_url('admin.php?page=themes&navigation=delete-theme&name='.$del_theme_info['Folder'].'&confirm=true'); ?>" class = "button-secondary"><?php echo __('Yes, Delete these files', 'framework'); ?></a>
