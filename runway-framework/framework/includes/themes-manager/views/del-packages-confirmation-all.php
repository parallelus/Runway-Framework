...
<a href="<?php echo $developer_tools->self_url('do-package').'&name='.$name.'&action=delete-package-all&package=all'; ?>" class = "button-secondary"><?php echo __('Yes, Delete these files', 'framework'); ?></a>
