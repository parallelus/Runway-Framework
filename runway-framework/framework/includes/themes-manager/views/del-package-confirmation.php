...
<a href="<?php echo esc_url( $developer_tools->self_url('do-package').'&name='.$name.'&action=delete-package&package='.$package ); ?>" class = "button-secondary"><?php echo __('Yes, Delete these files', 'framework'); ?></a>
