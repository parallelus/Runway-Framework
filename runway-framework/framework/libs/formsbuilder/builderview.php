<html>
	...
	<body>
		...
		<form class="save-page" method="post" action="<?php echo network_admin_url('admin.php?page=options-builder&amp;navigation=save-page'); ?>" enctype="multipart/form-data" style="display: none;">
