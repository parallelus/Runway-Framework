...
class FormsBuilder {
	...
	public $default_form_settings;
	public $save_action;
	public $save_custom_options_action;
	public $resolutions;
	public $formsbuilder_path;
	public $option_key;
	public $options_pages;
	public $section;

	public function __construct(
		$save_action = 'save_form_from_builder',
		$save_custom_options_action = 'save_custom_options'
	) {
	...
	// Include data-types
	public function load_data_types() {
	...
	public function get_custom_options_vals( $form = '', $custom_alias = false ) {
		...
		if ( $form != '' ) {
			...
			$vals = array(
				...
				'_framework_saved' => array(),// nothing todo
				'_other'           => array(),// nothing todo
				'_default'         => array(),// nothing todo
			);
...
if ( ! function_exists( 'formsbuilder_customize_sanitize_callback' ) ) {
	// required sanitize_callback (theme check)
	function formsbuilder_customize_sanitize_callback( $value ) {
