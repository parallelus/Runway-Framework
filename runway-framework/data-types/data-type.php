...
class Data_Type extends WP_Customize_Control {
	...
	public function enable_repeating( $field = array() ) {
		...
		if ( ! empty( $field ) ) {
			...
			<div id="<?php echo esc_attr( $add_id ); ?>">
				<a href="#"><?php _e( 'Add Field', 'runway' ); ?></a>
			</div>
	...
	public static function render_conditional_display() {
		...
		<div class="settings-container section-heading">
			...
			<p class="settings-field-caption">
				<?php echo __( 'Use the value of another option to conditionally show or hide this option.', 'runway' ); ?>
			</p>
			<div class="clear"></div>
		</div>
		...
		<div class="settings-container">
			<label class="settings-title"><?php echo __( 'Display action', 'runway' ); ?>:</label>
			<div class="settings-in">
				{{if ( typeof conditionalAction !== 'undefined' && conditionalAction == 'show' ) }}
					<label>
						<input data-set="conditionalAction" name="conditionalAction" value="show" checked="checked" type="radio">
						<?php echo __( 'Show', 'runway' ); ?>
					</label>
					<br>
					<label>
						<input data-set="conditionalAction" name="conditionalAction" value="hide" type="radio">
						<?php echo __( 'Hide', 'runway' ); ?>
					</label>
				{{else}}
					<label>
						<input data-set="conditionalAction" name="conditionalAction" value="show" type="radio">
						<?php echo __( 'Show', 'runway' ); ?>
					</label>
					<br>
					<label>
						<input data-set="conditionalAction" name="conditionalAction" value="hide" checked="checked" type="radio">
						<?php echo __( 'Hide', 'runway' ); ?>
					</label>
				{{/if}}
				<span class="settings-field-caption">
					<?php echo __( 'The action triggered by the conditional value.', 'runway' ); ?>
				</span>
			</div>
			<div class="clear"></div>
		</div>
