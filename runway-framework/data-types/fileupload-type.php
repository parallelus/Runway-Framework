...
class Fileupload_type extends Data_Type {
	...
	public function __construct( $page, $field, $wp_customize = null, $alias = null, $params = null ) {
		...
		$this->type  = 'fileupload-type';
		$this->label = 'Fileupload';
	...
	public function render_content( $vals = null ) {
		...
		if ( isset( $this->field->repeating ) && $this->field->repeating == 'Yes' ) {
			...
			for ( $key = 0; $key < $count; $key++ ) {
				...
				<input id="upload_image-<?php echo esc_attr( $this->field->alias ); ?>_<?php echo esc_attr( $key ); ?>"
				       class="custom-file-upload custom-data-type" <?php echo rf_string( $section ); // escaped above ?>
				       data-type="fileupload-type" type="text" size="36"
				...
				<span class="field_label">
					<button id="upload_image_button-<?php echo esc_attr( $this->field->alias . '_' . $key ); ?>" class="custom-file-upload-button button">
						<?php _e( 'Select File', 'runway' ); ?>
					</button>
				</span>
			...
			<span class="field_label">
				<button id="upload_image_button-<?php echo esc_attr( $this->field->alias ); ?>" class="button">
					<?php _e( 'Select File', 'runway' ); ?>
				</button>
			</span>
